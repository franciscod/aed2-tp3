...
namespace aed2 {
    ...
    /**
     * Esta clase implementa el m�dulo conjunto acotado de Naturales.
     * El m�dulo conjunto acotado de Naturales provee un conjunto en el que se
     * pueden insertar �nicamente los elementos que se encuentran en un rango [l, r]
     * de Naturales. La inserci�n, eliminaci�n y testeo de pertenencia de un
     ...
     * que tambi�n permite eliminar los elementos iterados.
     */
    class ConjAcotado {
